...
export const DEFAULT_SELECTORS = {
  ...
  partySizeOptionItem: "#party-size-input .drop-list li",
  ...
  /** Optional area/position (Zona) e.g. Sala interna, Bancone – only visible when AllowAreaChoice is true */
  areaDropdown: "#area-input .dropdown-selected, #area-input",
  areaOptionItem: "#area-input .drop-list li",
